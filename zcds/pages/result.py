...
class ResultPage(Page):
    ...
    # 2 种形态 x 若干十字单元(每单元 5 点), 任一形态【全中】即判为 result。
    #   形态 A(25 点) 失败页 x 聚光灯「亮相位」: 语料 23/35 帧全中。
    #   形态 B(30 点) 王座厅四角纯背景: 语料 35/35 帧全中 / 异页最高只中 0.27。
    ...
    prints = (
        ...
        [524, 218, 0x2F1A21], [524, 214, 0x2C1824], [440, 376, 0x361017],
        [442, 376, 0x3B1117], [438, 376, 0x350F17], [440, 378, 0x391218],
        [440, 374, 0x390F17], [24, 380, 0x26141E], [26, 380, 0x261414],
